...
internal sealed partial class MainForm
{
    ...
    private void ImportFilesIntoPane(string[] files, bool secondary, bool focusImported = true)
    {
        ...
        {
            if (secondaryWorkbook is null) return; FlushPendingEdits(secondaryGrid); secondaryWorkbook.ActiveSheet.Sheet = secondaryModel!;
    ...
    private void MoveDocumentBetweenPanes(bool sourcePrimary, int sourceIndex, bool targetPrimary, int insertionIndex)
    {
        ...
        if (sourcePrimary) { FlushPendingEdits(grid); CapturePrimaryDocument(); } else { FlushPendingEdits(secondaryGrid); CaptureSecondaryDocument(); }
